...
{
    protected $struct = StackPay\Payments\Structures\Capture::class;
    ...
    public function test_origionalTransaction()
    {
        $this->full('originalTransaction', Structures\Transaction::class, true);
    }

    public function test_capturedTransaction()
    {
        $this->full('capturedTransaction', Structures\Auth::class, true);
    }
}
