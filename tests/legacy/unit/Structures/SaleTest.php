...
{
    protected $struct = StackPay\Payments\Structures\Sale::class;
    ...
    {
        $this->full('account', Structures\Account::class, true);
    }

    public function test_accountHolder()
    {
        $this->full('accountHolder', Structures\AccountHolder::class);
    }
}
