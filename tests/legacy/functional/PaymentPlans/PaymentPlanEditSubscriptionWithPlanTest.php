				...
				'data' => [
					...
					'scheduled_transactions'    => [
						[
							...
							'status'                => $subscription->scheduledTransactions()[0]->status(),
						...
						[
							...
							'status'                => $subscription->scheduledTransactions()[1]->status(),
						...
						[
							...
							'status'                => $subscription->scheduledTransactions()[2]->status(),
